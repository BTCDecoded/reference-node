...
mod kani_proofs {
    ...
    fn verify_getheaders_message_roundtrip() {
        ...
        kani::assume(getheaders_msg.block_locator_hashes.len() <= proof_limits::MAX_HEADERS_COUNT_FOR_PROOF);
    ...
    fn verify_blocktxn_message_roundtrip() {
        ...
        for tx in &msg.transactions {
            crate::network::kani_helpers::assume_tx_message_bounds!(&crate::network::protocol::TxMessage { transaction: tx.clone() });
        }
