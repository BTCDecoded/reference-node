...
impl ModuleDependencies {
    ...
    pub fn resolve(
        ...
        for module in discovered_modules {
            let module_deps: Vec<String> = module.manifest.dependencies
                .keys()
                .cloned()
                .collect();
        ...
        let load_order = Self::topological_sort(&dependencies)
            .map_err(|e| ModuleError::DependencyMissing(format!(
