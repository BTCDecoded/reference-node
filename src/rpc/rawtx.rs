...
impl RawTxRpc {
    ...
    pub async fn gettxout(&self, params: &Value) -> RpcResult<Value> {
        ...
        let _include_mempool = params.get(2)
            .and_then(|p| p.as_bool())
            .unwrap_or(true);
